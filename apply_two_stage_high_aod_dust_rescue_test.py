...
CASES = {
    ...
    "mar19_red_sea_arabia": Case(
        name="mar19_red_sea_arabia",
        date="2017-03-19",
        label="Red Sea / Arabian Peninsula",
        lat_min=5.0,
        lat_max=35.0,
        lon_min=25.0,
        lon_max=65.0,
        min_pixels=50,
        rois=(
            ("full_domain", 25.0, 65.0, 5.0, 35.0),
            ("red_sea_corridor", 32.0, 44.0, 12.0, 28.0),
            ("arabian_peninsula", 42.0, 58.0, 12.0, 30.0),
            ("northeast_africa", 25.0, 38.0, 12.0, 28.0),
        ),
    ),
    "feb5_west_central_sahel": Case(
        name="feb5_west_central_sahel",
        date="2017-02-05",
        label="West/Central Sahel",
        lat_min=5.0,
        lat_max=18.0,
        lon_min=-15.0,
        lon_max=25.0,
        min_pixels=50,
        rois=(
            ("full_domain", -15.0, 25.0, 5.0, 18.0),
            ("western_sahel", -15.0, 0.0, 8.0, 18.0),
            ("central_sahel", 0.0, 15.0, 8.0, 18.0),
            ("eastern_sahel", 15.0, 25.0, 8.0, 18.0),
        ),
    ),
    "oct31_west_central_sahel": Case(
        name="oct31_west_central_sahel",
        date="2017-10-31",
        label="West/Central Sahel",
        lat_min=5.0,
        lat_max=18.0,
    ...
    "dec25_west_central_sahel": Case(
        name="dec25_west_central_sahel",
        date="2017-12-25",
        label="West/Central Sahel",
        lat_min=5.0,
        lat_max=18.0,
